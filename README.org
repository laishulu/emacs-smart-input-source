...
| ~smart-input-source-other-input-source~        | Input source for other language                                     | ~com.sogou.inputmethod.sogou.pinyin~ |
| ~smart-input-source-aggressive-line~           | Aggressively detect context across blank lines                      | ~t~                                  |
| ~smart-input-source-external-ism~              | input resource manager                                              | ~macism~                             |
| ~smart-input-source-do-get-input-source~       | Function to get the current input source                            | determined from the environment      |
| ~smart-input-source-do-set-input-source~       | Function to set the input source                                    | determined from the environment      |
| ~smart-input-source-start-with-english~        | Start the mode with english input source                            | ~t~                                  |
| ~smart-input-source-with-inline-english~       | With the inline English feature                                     | ~t~                                  |
| ~smart-input-source-tighten-other-punctuation~ | Auto delete blank between inline english and other lang punctuation | ~t~                                  |
|------------------------------------------------+---------------------------------------------------------------------+--------------------------------------|
