...
|------------------------------------------------+--------------------------------------------+-------------------------------------------------|
| ~evil-smart-input-source-english-pattern~      | Pattern to identify a character as english | src_elisp{"[a-zA-Z]"}                           |
| ~evil-smart-input-source-other-pattern~        | Pattern to identify a character as blank   | src_elisp{"\\cc"}                               |
| ~evil-smart-input-source-blank-pattern~        | Pattern to identify a character as blank   | src_elisp{"[:blank:]"}                          |
| ~evil-smart-input-source-english-input-source~ | Input source for english                   | src_elisp{"com.apple.keylayout.US"}             |
| ~evil-smart-input-source-other-input-source~   | Input source for other lanugage            | src_elisp{"com.sogou.inputmethod.sogou.pinyin"} |
| ~evil-smart-input-source-external-ism~         | Path of macism                             | src_elisp{"macism"}                             |
