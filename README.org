...
| ~smart-input-source-other-pattern~        | Pattern to identify a character as other   | #+BEGIN_SRC lisp \cc #+END_SRC see [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Regexp-Backslash.html][emacs manual]]                                 |
...
| ~smart-input-source-inline-english-face~  | Face for the online english region overlay | #+BEGIN_SRC lisp '(:inherit font-lock-constant-face :inverse-video t) #+END_SRC |
|-------------------------------------------+--------------------------------------------+---------------------------------------------------------------|
