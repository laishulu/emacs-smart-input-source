#+TITLE: README
[[https://melpa.org/#/smart-input-source][file:https://melpa.org/packages/sis-badge.svg]]

* About
This package provide several modes to switch native or OS input sources smartly:
...
#+BEGIN_SRC lisp
(sis-ism-lazyman-config nil "rime" 'emacs)
#+END_SRC
...
| ~sis-respect-evil-normal-escape~                | esc to English from evil normal sate                   | ~t~                    |
